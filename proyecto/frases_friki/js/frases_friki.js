document.addEventListener("DOMContentLoaded", function() {
    ...
    frasesFrikisInformatica = [ "Los programadores no tienen errores, solo experiencias inesperadas.", 
        ...
        "La curiosidad es la fuerza impulsora detrás del aprendizaje en la programación: los programadores curiosos están siempre buscando aprender algo nuevo y emocionante para mejorar sus habilidades.", "La determinación es la fuerza que impulsa a los programadores a perseverar a través de los desafíos y obstáculos en su camino hacia el éxito en la programación.", 
        "La programación es como una danza entre la lógica y la creatividad: los programadores equilibran el rigor técnico con la libertad de expresión para crear soluciones elegantes y eficientes que resuelvan problemas complejos.", "Los buenos programadores no solo resuelven problemas, ¡encuentran formas innovadoras de hacer las cosas mejor y más eficientemente!", 
        "La programación es como una aventura en un mundo de ceros y unos: los programadores exploran territorios desconocidos y descubren nuevas formas de hacer las cosas.", "La creatividad es el combustible que alimenta la innovación en la programación: los programadores creativos ven los desafíos como oportunidades para pensar de manera diferente y encontrar soluciones únicas que mejoren la vida de las personas.", 
